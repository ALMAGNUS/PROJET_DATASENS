...
def check_kaggle():
    ...
    print("   - 76 680 articles extraits depuis Kaggle")
    print(f"   - {kaggle_in_db} articles deja dans la DB")
    print("   - Le pipeline doit traiter tous les nouveaux articles")
    print("\nLe pipeline va:")
    print("   1. Nettoyer les articles")
    print("   2. Les charger dans la DB (avec deduplication)")
    print("   3. Les tagger (topics)")
    print("   4. Les analyser (sentiment)")
    print("   5. Les agreger")
    print("   6. Les exporter")
