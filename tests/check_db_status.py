...
def check_db_status():
    ...
    print("   - C'est la deduplication qui fonctionne")
    print("   - Les articles deja dans la DB sont ignores (c'est voulu)")
    print("   - Le code a ete corrige pour ne plus afficher ces erreurs")
