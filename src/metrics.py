...
articles_loaded_total = Counter(
    ...
    'Total articles loaded to database',
    registry=registry
)
...
articles_deduplicated_total = Counter(
    'datasens_articles_deduplicated_total',
...
articles_in_database = Gauge(
    ...
    'Current number of articles in database',
    registry=registry
)
...
source_errors_total = Counter(
    'datasens_source_errors_total',
    'Total source extraction errors',
    ['source'],
    registry=registry
)
